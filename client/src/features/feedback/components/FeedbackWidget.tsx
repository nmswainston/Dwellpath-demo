...
const FEEDBACK_TYPES = [
  ...
  { type: 'negative' as const, label: 'Negative', icon: ThumbsDown, color: 'bg-[hsl(var(--status-risk))]', description: 'Something needs improvement' },
  { type: 'bug' as const, label: 'Bug Report', icon: Bug, color: 'bg-[hsl(var(--status-warning))]', description: 'Report a technical issue' },
  { type: 'suggestion' as const, label: 'Suggestion', icon: Lightbulb, color: 'bg-[hsl(var(--status-neutral))]', description: 'Suggest a new feature' },
  { type: 'general' as const, label: 'General', icon: MessageSquare, color: 'bg-muted-foreground/70', description: 'General feedback' },
];
          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <Button
                ...
                disabled={submitFeedbackMutation.isPending}
              >
                <ThumbsDown className="h-4 w-4 text-[hsl(var(--status-risk))]" />
