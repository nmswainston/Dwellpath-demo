...
export default function AIChat() {
  ...
  const allMessages = [...chatHistory, ...recentChats].slice(0, 5);
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <CardTitle className="font-heading text-lg font-bold text-brand-primary dark:text-foreground flex items-center gap-2">
              ...
              Ask Dwellpath AI
              <Badge variant="secondary" className="text-xs bg-blue-100 text-blue-700 font-body px-2 py-0.5">AI</Badge>
            </CardTitle>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-brand-primary rounded-full animate-pulse"></div>
            <span className="text-xs text-brand-text-light/60 dark:text-brand-text-dark/60 font-body">Online</span>
          </div>
        </div>
      </CardHeader>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <div className="bg-muted rounded-lg px-3 py-2">
                  <p className="text-sm text-brand-text-light dark:text-brand-text-dark font-body">
              ...
              <div key={index} className="space-y-3">
                ...
                <div className="flex items-start space-x-3 justify-end">
                  <div className="flex-1 text-right">
                    <div className="bg-primary text-white rounded-lg px-4 py-3 inline-block max-w-md">
                    ...
                    <p className="text-xs text-brand-text-light/60 dark:text-brand-text-dark/60 mt-1">
                      {format(new Date(chat.timestamp || chat.createdAt), "h:mm a")}
                    </p>
                  </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <div className="bg-muted rounded-lg px-4 py-3 max-w-4xl">
                      <p className="text-sm text-brand-text-light dark:text-brand-text-dark whitespace-pre-wrap leading-relaxed">
                        {chat.aiResponse}
                      </p>
                    </div>
                    <p className="text-xs text-brand-text-light/60 dark:text-brand-text-dark/60 mt-1">
