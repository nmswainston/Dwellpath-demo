      ...
      <Card>
        <CardHeader className="pb-4">
          <CardTitle className="font-heading text-lg font-bold text-brand-primary dark:text-foreground flex items-center gap-2">
            <Clock className="h-5 w-5 text-brand-primary dark:text-accent" />
            Recent Activity
          </CardTitle>
        </CardHeader>
        <CardContent>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-brand-text-light dark:text-brand-text-dark leading-relaxed">{activity.title}</p>
                    <p className="text-sm text-brand-text-light/60 dark:text-brand-text-dark/60 leading-relaxed">{activity.description}</p>
