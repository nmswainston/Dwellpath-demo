    ...
    <div className="mb-6 winter-card border-l-4 border-l-brand-bg-dark">
      <Alert variant={getAlertVariant(criticalAlert.severity || 'default')} className="bg-transparent border-0 shadow-none">
        <div className="flex items-start space-x-3">
          <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-brand-bg-light/50 dark:bg-brand-bg-dark/50 text-brand-text-light dark:text-brand-text-dark">
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center space-x-2 mb-1">
                  <p className="font-semibold text-brand-text-light dark:text-brand-text-dark">{criticalAlert.title}</p>
                  <div className={cn(
                    "state-badge text-xs",
                    criticalAlert.severity === 'critical' ? "risk-critical" : "risk-medium"
                  )}>
