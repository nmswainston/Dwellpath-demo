...
import type { ResidencyLog, Expense, JournalEntry } from "@shared/schema";
...
export default function Export() {
  ...
  const { data: residencyStats = [] } = useQuery<ResidencyStat[]>({
  ...
  const { data: residencyLogs = [] } = useQuery<ResidencyLog[]>({
...
EXPENSE SUMMARY
===============
Total Expenses: $${expenses.reduce((sum, exp) => sum + parseFloat(exp.amount), 0).toLocaleString()}
By State:
${Object.entries(
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Loading export tools...</p>
        </div>
      </div>
    );
  }
    ...
    >
      <div className="page-container">
        <StaggeredPageContent>
            ...
            <Card className="mb-8">
            <CardHeader>
              <CardTitle className="break-words">Export Settings</CardTitle>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Select value={exportYear} onValueChange={setExportYear}>
                    <SelectTrigger id="exportYear" name="exportYear">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 font-heading text-lg font-bold text-brand-primary dark:text-foreground min-w-0">
                    <Download className="h-5 w-5 text-brand-primary dark:text-accent flex-shrink-0" />
                    <span className="truncate">Data Exports</span>
                  </CardTitle>
                  <CardDescription className="break-words">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 font-heading text-lg font-bold text-brand-primary dark:text-foreground min-w-0">
                    <Shield className="h-5 w-5 text-brand-primary dark:text-accent flex-shrink-0" />
                    <span className="truncate">Compliance Reports</span>
                  </CardTitle>
                  <CardDescription className="break-words">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 font-heading text-lg font-bold text-brand-primary dark:text-foreground min-w-0">
                  <FileText className="h-5 w-5 text-brand-primary dark:text-accent flex-shrink-0" />
                  <span className="truncate">Audit Letter Generator</span>
                </CardTitle>
                <CardDescription className="break-words">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Select value={selectedState} onValueChange={setSelectedState}>
                    <SelectTrigger id="auditState" name="auditState">
                  ...
                  <>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <Label className="min-w-0 flex-1 truncate">Generated Letter Preview</Label>
                        <Button size="sm" onClick={downloadLetter} className="flex-shrink-0">
          ...
          <Card className="mt-8">
            <CardHeader>
              <CardTitle className="font-heading text-lg font-bold text-brand-primary dark:text-foreground break-words">Export Guidelines</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-muted-foreground">
                <div>
                  <h4 className="font-medium text-foreground mb-2">Data Exports</h4>
                ...
                <div>
                  <h4 className="font-medium text-foreground mb-2">Audit Preparation</h4>
                  <ul className="space-y-1">
